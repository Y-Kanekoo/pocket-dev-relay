...
export const MAX_FILE_SIZE: number = validateInt(
  'MAX_FILE_SIZE',
...
export const DATA_DIR: string = path.resolve(
  process.env.DATA_DIR || path.join(ROOT_DIR, '.pocket-dev-relay'),
);

/** ログ保持日数（デフォルト: 30日） */
export const LOG_MAX_AGE_DAYS: number = validateInt(
  'LOG_MAX_AGE_DAYS',
  process.env.LOG_MAX_AGE_DAYS,
  30,
  1,
  Number.MAX_SAFE_INTEGER,
);
...
export const LOG_MAX_SIZE_MB: number = validateInt(
  'LOG_MAX_SIZE_MB',
...
export const MAX_UPLOAD_SIZE: number = validateInt(
  'MAX_UPLOAD_SIZE',
...
export const AI_MAX_CONTEXT_LINES: number = validateInt(
  'AI_MAX_CONTEXT_LINES',
  process.env.AI_MAX_CONTEXT_LINES,
  200,
  1,
  Number.MAX_SAFE_INTEGER,
);
...
export const RATE_LIMIT_API: number = validateInt(
  'RATE_LIMIT_API',
...
/** 認証失敗のレート制限（回数/分） */
export const RATE_LIMIT_AUTH: number = validateInt(
  'RATE_LIMIT_AUTH',
  process.env.RATE_LIMIT_AUTH,
  5,
  1,
  Number.MAX_SAFE_INTEGER,
);
...
export const SESSION_TIMEOUT: number = validateInt(
  'SESSION_TIMEOUT',
...
/** SSHデフォルトポート */
export const SSH_DEFAULT_PORT: number = validateInt(
  'SSH_DEFAULT_PORT',
  process.env.SSH_DEFAULT_PORT,
  22,
  1,
  65535,
);
...
export const TUNNEL_TIMEOUT: number = validateInt(
  'TUNNEL_TIMEOUT',
  process.env.TUNNEL_TIMEOUT,
  30000,
  1000,
  Number.MAX_SAFE_INTEGER,
);
...
export const APP_VERSION: string = (() => {
  try {
    ...
    console.warn(
      'APP_VERSION: package.jsonの読み込みに失敗しました。デフォルト値 "0.0.0" を使用します。',
      error,
    );
    return '0.0.0';
  }
