 ...
 */
router.get('/files', authMiddleware, asyncHandler(async (req: Request, res: Response) => {
 ...
 */
router.get('/file', authMiddleware, asyncHandler(async (req: Request, res: Response) => {
  const relativePath = (req.query.path as string) || '';
  let targetPath: string;
 ...
 */
router.post('/file', authMiddleware, asyncHandler(async (req: Request, res: Response) => {
  if (!ALLOW_FILE_WRITE) {
